...
Input:["MyCircularQueue","enQueue","Rear","Front","deQueue","Front","deQueue","Front","enQueue","enQueue","enQueue","enQueue"]
        [[3],[2],[],[],[],[],[],[],[4],[2],[2],[3]]
Output:[null,true,2,2,true,-1,false,-1,true,true,true,false]


Input:["MyCircularQueue","enQueue","Rear","Rear","deQueue","enQueue","Rear","deQueue","Front","deQueue","deQueue","deQueue"]
        [[6],[6],[],[],[],[5],[],[],[],[],[],[]]
Output:[null,true,6,6,true,true,5,true,-1,false,false,false]
...
isFull. 
 ...
 Related Topics 设计 队列 数组 链表 👍 406 👎 0
...
class MyCircularQueue:
    ...
    def Front(self) -> int:
        if self.isEmpty():
            ...
            return self.d[self.tail % len(self.d)]

    def Rear(self) -> int:
        if self.isEmpty():
            return -1
        else:
            return self.d[(self.head - 1) % len(self.d)]

    def isEmpty(self) -> bool:
        return self.head == self.tail

    def isFull(self) -> bool:
        return (self.head + 1) % len(self.d) == self.tail
...
if __name__ == "__main__":
    TestObj = StartTest(question_content, MyCircularQueue, isDesignedClass=True)
    TestObj.run_test()
